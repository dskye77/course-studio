// components/dev/layouts/Sidebar.jsx
"use client";

import Link from "next/link";
import { usePathname } from "next/navigation";
import Image from "next/image";
import { Home, BookOpen, LogOut, UserRound, ImageIcon } from "lucide-react";
    ...
    <aside className="w-64 h-screen bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex flex-col">
      ...
      <nav className="flex-1 px-4 space-y-1">
        ...
        <Link
          href="/dev/courses"
          className={`flex items-center gap-3 px-4 py-3 rounded-lg transition ${
            isActive("/dev/courses") && !isActive("/dev/uploads")
              ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 font-medium"
              : "hover:bg-gray-100 dark:hover:bg-gray-800"
          }`}
        >
